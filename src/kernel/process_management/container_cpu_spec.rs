...
verus! {
    ...
    pub closed spec fn container_cpu_wf(container_perms: LockedMap<RwLockContainerPtr, Container, ContainerRO, CONTAINER_HAS_KILL_STATE>, cpu_array:LockedArray<Cpu, (), NUM_CPUS, CPU_HAS_KILL_STATE>) -> bool {
    ...
    pub open spec fn container_cpu_wf_inner(container_perms: LockedMap<RwLockContainerPtr, Container, ContainerRO, CONTAINER_HAS_KILL_STATE>, cpu_array:LockedArray<Cpu, (), NUM_CPUS, CPU_HAS_KILL_STATE>) -> bool {
        &&&
