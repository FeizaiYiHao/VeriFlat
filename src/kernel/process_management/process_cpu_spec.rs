...
verus! {
    #[verifier::opaque]
    pub open spec fn process_cpu_wf(process_map: LockedMap<RwLockProcessPtr, Process, ReadOnlyNode<ProcessRO>, (), (), PROCESS_HAS_KILL_STATE>, cpu_array:LockedArray<Cpu, (), (), (), NUM_CPUS, CPU_HAS_KILL_STATE>) -> bool {
        &&&
        forall|cpu_i:CpuId|
