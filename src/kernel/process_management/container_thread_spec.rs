...
verus! {
   pub proof fn container_thread_wf_proof()
        ensures
            forall|container_map: LockedMap<RwLockContainerPtr, Container, ContainerRO, CONTAINER_HAS_KILL_STATE>, thread_map: LockedMap<RwLockThreadPtr, Thread, (), THREAD_HAS_KILL_STATE>|
                container_thread_wf(container_map, thread_map) <==> container_thread_wf_inner(container_map, thread_map)
    {}

    pub closed spec fn container_thread_wf(container_map: LockedMap<RwLockContainerPtr, Container, ContainerRO, CONTAINER_HAS_KILL_STATE>, thread_map: LockedMap<RwLockThreadPtr, Thread, (), THREAD_HAS_KILL_STATE>) -> bool {
        container_thread_wf_inner(container_map, thread_map)
    }
    pub open spec fn container_thread_wf_inner(container_map: LockedMap<RwLockContainerPtr, Container, ContainerRO, CONTAINER_HAS_KILL_STATE>, 
