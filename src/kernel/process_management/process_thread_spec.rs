...
verus! {
   pub proof fn process_thread_wf_proof()
        ensures
            forall|process_map: LockedMap<RwLockProcessPtr, Process, (), PROCESS_HAS_KILL_STATE>, thread_map: LockedMap<RwLockThreadPtr, Thread, (), THREAD_HAS_KILL_STATE>|
                process_thread_wf(process_map, thread_map) <==> process_thread_wf_inner(process_map, thread_map)
    {}

    pub closed spec fn process_thread_wf(process_map: LockedMap<RwLockProcessPtr, Process, (), PROCESS_HAS_KILL_STATE>, thread_map: LockedMap<RwLockThreadPtr, Thread, (), THREAD_HAS_KILL_STATE>) -> bool {
        process_thread_wf_inner(process_map, thread_map)
    }
    pub open spec fn process_thread_wf_inner(process_map: LockedMap<RwLockProcessPtr, Process, (), PROCESS_HAS_KILL_STATE>, 
