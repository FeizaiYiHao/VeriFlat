...
verus! {
        pub proof fn container_process_allocator_quota_proof()
            ensures 
                ...
                container_process_allocator_quota_wf(container_map, process_map, thread_map, allocator_4k_map, allocator_2m_map, allocator_1g_map)
                <==> 
                {
                    &&&
                    container_process_allocator_quota_4k_wf_inner(container_map, process_map, thread_map, allocator_4k_map)
                    &&&
                    container_process_allocator_quota_2m_wf_inner(container_map, process_map, thread_map, allocator_2m_map)
                    &&&
                    container_process_allocator_quota_1g_wf_inner(container_map, process_map, thread_map, allocator_1g_map)
                }
        {}
