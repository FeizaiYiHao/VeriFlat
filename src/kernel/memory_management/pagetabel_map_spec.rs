...
verus! {
    pub open spec fn pagetable_perms_wf(pagetable_perms: LockedMap<RwLockPageTableRoot, PageTable<PT_TYPE>, (), (), PAGE_TABLE_HAS_KILL_STATE>) -> bool{
        ...
        &&&
        pagetables_or_inv(pagetable_perms)
    }
    pub open spec fn pagetables_or_inv(pagetable_perms: LockedMap<RwLockPageTableRoot, PageTable<PT_TYPE>, (), (), PAGE_TABLE_HAS_KILL_STATE>) -> bool{
        &&&
